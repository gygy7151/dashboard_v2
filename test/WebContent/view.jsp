				...
				<table class="table table-striped"
					...
					<tbody>
						<tr>
							...
							<td colspan="2"><%= bbs.getListTitle().replaceAll(" ", "&nbsp;").replaceAll("<", "$lt;").replaceAll(">", "$gt;").replaceAll("\n", "<br>")%></td>
						<tr>
							<td>작성자</td>
						...
						<tr>
							<td>내용</td>
							<td colspan="2" style="min-height: 200px; text-align: left;"><%= bbs.getListContent().replaceAll(" ", "&nbsp;").replaceAll("<", "$lt;").replaceAll(">", "$gt;").replaceAll("\n", "<br>") %></td>
						</tr>
					</tbody>
				</table>
