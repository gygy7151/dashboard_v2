		...
		<div class="row">
			<form method="post" accept-charset="utf-8" action="writeGo.jsp">
				<table class="table table-striped"
					...
					<tbody>
						<tr>
							<td><input type="text" class="form-control" placeholder="글제목" name="listTitle" maxlength="50"></td>
						</tr>
						<tr>
							<td><textarea class="form-control" placeholder="글내용" name="listContent" maxlength="2048" style="height: 350px;"></textarea></td>
						</tr>
					</tbody>
				</table>
